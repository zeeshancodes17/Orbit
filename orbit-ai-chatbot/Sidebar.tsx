        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-slate-800 dark:text-white">Orbit</h1>
            </div>
            <button 
          ...
          <div className="p-4">
            <button 
              ...
              className="w-full flex items-center justify-center space-x-2 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all shadow-md shadow-indigo-200 dark:shadow-none font-medium"
            >
